...
@Singleton
@Component
public final class YIronOxideAppRunner {

    private static final Logger log = LoggerFactory.getLogger(YIronOxideAppRunner.class);
    ...
    @Inject
    public YIronOxideAppRunner(final ScheduledExecutorService cron,
