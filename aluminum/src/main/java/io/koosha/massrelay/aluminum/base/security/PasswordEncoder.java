...
public interface PasswordEncoder {
    ...
    static PasswordEncoder bcrypt(int strength) {
        return new BCryptPasswordEncoder(strength, null);
    }
     ...
     * match, false if they do not. The stored password itself is never
     * decoded.
     *
